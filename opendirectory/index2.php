...
<?php
    ...
    {
			$l = "mw.png";
			if ($file == "graph-paper" || $file == "2014_BarbieKenGoBungeeJumping" )$l = "directory.png";
			
        if ($file != "." && $file != ".."&& $file != "index.php"&& $file != "directory.png"&& $file != "mw.png"&& $file != "wamc-logo-monarchs2.png")     
        {
            //$thelist .= "' <img src ='".$l.'"><a href="'.$file.'"class = "bttn bttn2" target = "_blank">'.$file.'</a>';
             $thelist .= '<img src = '.$l.'><a href="'.$file.'"class = "bttn bttn2" target = "_blank">'.$file.'</a><br />';
        }
    }
    closedir($handle);
    }
...
<hr />
FILES = <img src = "mw.png">  &nbsp;&nbsp; DIRECTORIES <img src = "directory.png">
</div>
